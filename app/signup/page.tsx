...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#F9F8F5] text-[#1A1A1A]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 bg-white border-r border-[#E5E5E5]">
        <motion.div
        ...
        >
          <div className="space-y-2">
            <h2 className="text-3xl font-serif">Begin the Journey</h2>
            <p className="text-gray-500 font-light">Create your account to start tracking.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-xs uppercase tracking-widest text-gray-500 font-semibold">
                  Confirm Password
                </Label>
                <Input
                  id="confirmPassword"
        ...
        <div className="max-w-lg space-y-8">
          ...
          >
            ...
            <h1 className="text-7xl font-serif leading-[0.9] tracking-tight mb-6">
              Design Your <br />
              <span className="italic text-gray-400">Mind.</span>
            </h1>
            <p className="text-lg text-gray-600 font-light leading-relaxed max-w-sm">
              Join a community dedicated to mental clarity. Use AI to unlock insights about your habits, moods, and goals.
            </p>
          </motion.div>
